...
function echoHost() {
	...
	//var formData = new FormData( document.getElementById("datastore") );
	//xhr.send(formData);
}
...
<div id="datalayer" style="border:0px;width:100px;height:100px;position:absolute;top:0px;left:02px;visibility:hidden;">
	<form name="datastore" action="updateHost.php" onsubmit="return updateHost(this);" >  <!-- All point data is written in here from the slider or other controls.  This serves as a RAM function of sorts. -->
		<input type="hidden" name="activeHost" id="activeAttrib" value="<?= $host_name ?>" />          <!--  Which Attribute is currently selected -->
