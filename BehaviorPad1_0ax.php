...
function setVal(attVal) {  //attVal = 0 to 100; reads selected attrib (activeAttrib.value), sets the 0-100 value into the hidden input for the selected value, then converts 0 ro 100 value to pixel coords to clip the polygon
    ...
    <script language="JavaScript">
      ...
      document.write('	<input type="range" orient="vertical" min="0" max="100" value="50" id="testRange" onmousemove="setVal(this.value)" style="height:' + ocD + 'px;width:20px;position:absolute;top:' + ccD*3 + 'px;left:' + ccD*1.77 + 'px;" /><br />')
      document.write('</form>')
