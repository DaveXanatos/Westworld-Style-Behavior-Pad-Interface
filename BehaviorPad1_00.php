...
function cancelMods() {                           // Cancel Button in upper left.
	...
	if (confirm("Discard all changes to host profile and revert to original?") == true) {
		window.location.href = "BehaviorPad_15.php?req=LH&hName="+whichHost
	} else {
    	return false;
  }
}
...
<script language="JavaScript">
  ...
  document.write('<a href="#" onClick="cancelMods();"><img src="image/button-cancel.jpg" style="width:' + ccD + 'px;height:' + ccD*.27 + 'px;position:absolute;top:' + ccD*1.25 + 'px;left:' + ccD*.6 + 'px;" /></a>')
  document.write('<a href="#" onClick="echoHost();"><img src="image/button-modify.jpg" style="width:' + ccD + 'px;height:' + ccD*.27 + 'px;position:absolute;top:' + ccD*1.25 + 'px;left:' + ccD*1.7 + 'px;" /></a>')
